...
//  Commented everything because of non-refactored code
...
public class SceneOld
{
	...
	public SceneOld(Director mn, String source, String prev, PixelCanvas can, GraphicsResourceJump animations, double pX, double pY)
	{
		this.mn = mn;
